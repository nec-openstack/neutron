...
class PFCDriverBase(ofc_driver_base.OFCDriverBase):
    ...
    def create_network(self, ofc_tenant_id, description, network_id=None):
        ...
        # network name is passed in 'description' and update the description
        # with neutron network_id as PFC ID is generated by PFC.
        desc = "ID=%s Name=%s at Neutron." % (network_id, description)
        pfc_desc = self._generate_pfc_description(desc)
...
class PFCDriverBase2(PFCDriverBase):

    def _generate_pfc_str(self, raw_str):
        """Generate PFC acceptable String."""
        # Printable characters except ? (\042) and " (\077)
        return re.sub(r'[^\040-\041\043-\076\100-\176]', '_', raw_str)
...
class PFCV51Driver(PFCFilterDriverMixin,
                   PFCRouterDriverMixin,
                   PFCDriverBase2):
    pass
